...
# NOTE (christiangeorgelucas/audio-tools): upstream librosa also re-exports
# example/ex (pooch-backed demo-file fetchers) here. This vendored, patched
# copy never defines them — see vendor/librosa/util/files.py — because
# audio-tools is offline/deterministic and never fetches remote audio.
