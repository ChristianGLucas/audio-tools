...
def __trim_beats(localscore, beats, trim):
    ...
    # christiangeorgelucas/audio-tools patch: scipy removed the deprecated
    # top-level scipy.signal.hann alias (moved to scipy.signal.windows.hann
    # some releases ago); we pin a current scipy, so call the new location.
